...
const Setting: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gray-100 p-4 sm:p-6">
      <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8 w-full max-w-3xl">
        {/* Profile Section */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div>
            ...
            <input
              ...
              className="mt-2 w-full rounded h-10 bg-gray-100 disabled:bg-gray-200 disabled:cursor-not-allowed focus:outline-none focus:border-2 focus:border-green-500 p-2"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
            ...
            <input
              ...
              className="mt-2 w-full rounded h-10 bg-gray-100 cursor-not-allowed focus:outline-none focus:border-2 focus:border-green-500 p-2"
            />
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative mt-2">
              <input
                ...
                className="w-full p-2 pr-10 bg-gray-100 disabled:bg-gray-200 disabled:cursor-not-allowed rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
              />
              <button
                type="button"
          ...
          <div>
            ...
            <div className="relative mt-2">
              <input
                ...
                className="w-full p-2 bg-gray-100 disabled:bg-gray-200 disabled:cursor-not-allowed pr-10 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
              />
              <button
                type="button"
